...
use icm42670::{Address, Icm42670, FifoDataP3, FifoDataSiP3, FifoPacketType}; //prelude::*, 
...
fn main() -> ! {
    ...
    loop {
        ...
        let _ret = icm.read_fifo(&mut fifodata);
        ...
        if (fifodata[0] & 0x80) == 0x80 {
            ...
            //                                    fdatasi.ts);
            let (dcm, _gyro_biases) = dcmimu.update(((0.01), (0.02), (0.01)),
                                                (0.04, 0.03, 0.02),
                                                0.005);
